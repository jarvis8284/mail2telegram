...
// node_modules/.pnpm/error-kid@0.0.7/node_modules/error-kid/dist/index.js
...
// node_modules/.pnpm/@telegram-apps+init-data-node@2.0.10_typescript@5.9.3/node_modules/@telegram-apps/init-data-node/dist/entries/shared-aDQj8NQw.js
...
// node_modules/.pnpm/@telegram-apps+init-data-node@2.0.10_typescript@5.9.3/node_modules/@telegram-apps/init-data-node/dist/entries/web.js
...
var t = ({ base: e2 = "", routes: t3 = [], ...o3 } = {}) => ({ __proto__: new Proxy({}, { get: (o4, r3, a2, s2) => (o5, ...n2) => t3.push([r3.toUpperCase?.(), RegExp(`^${(s2 = (e2 + o5).replace(/\/+(\/|$)/g, "$1")).replace(/(\/?\.?):(\w+)\+/g, "($1(?<$2>*))").replace(/(\/?\.?):(\w+)/g, "($1(?<$2>[^$1/]+?))").replace(/\./g, "\\.").replace(/(\/?)\*/g, "($1.*)?")}/*$`), n2, s2]) && a2 }), routes: t3, ...o3, async fetch(e3, ...r3) {
  let a2, s2, n2 = new URL(e3.url), c3 = e3.query = { __proto__: null };
  for (let [e4, t4] of n2.searchParams) c3[e4] = c3[e4] ? [].concat(c3[e4], t4) : t4;
  e: try {
    for (let t4 of o3.before || []) if (null != (a2 = await t4(e3.proxy ?? e3, ...r3))) break e;
    t: for (let [o4, c4, l3, i] of t3) if ((o4 == e3.method || "ALL" == o4) && (s2 = n2.pathname.match(c4))) {
      e3.params = s2.groups || {}, e3.route = i;
      for (let t4 of l3) if (null != (a2 = await t4(e3.proxy ?? e3, ...r3))) break t;
    }
  } catch (t4) {
    if (!o3.catch) throw t4;
    a2 = await o3.catch(t4, e3.proxy ?? e3, ...r3);
  }
  try {
    for (let t4 of o3.finally || []) a2 = await t4(a2, e3.proxy ?? e3, ...r3) ?? a2;
  } catch (t4) {
    if (!o3.catch) throw t4;
    a2 = await o3.catch(t4, e3.proxy ?? e3, ...r3);
  }
...
var o = (e2 = "text/plain; charset=utf-8", t3) => (o3, r3 = {}) => {
  if (void 0 === o3 || o3 instanceof Response) return o3;
  const a2 = new Response(t3?.(o3) ?? o3, r3.url ? void 0 : r3);
  return a2.headers.set("content-type", e2), a2;
};
var r = o("application/json; charset=utf-8", JSON.stringify);
var p2 = o("text/plain; charset=utf-8", String);
var f2 = o("text/html");
var u2 = o("image/jpeg");
var h = o("image/png");
var g = o("image/webp");
...
function toCamelCase(key) {
  return key.replace(/-(.)/g, (o3, c3) => c3.toUpperCase());
}
...
async function renderEmailPreviewMode(mail, env) {
  const header = [
    `\u{1F4E7} \u4E3B\u9898: ${mail.subject}`,
    `\u{1F4E4} \u53D1\u4EF6\u4EBA: ${mail.from}`,
    `\u{1F4E5} \u6536\u4EF6\u4EBA: ${mail.to}`,
    mail.date ? `\u{1F550} \u65F6\u95F4: ${new Date(mail.date).toLocaleString("zh-CN", { timeZone: "Asia/Shanghai" })}` : null,
    "",
    "\u2500".repeat(40),
    ""
  ].filter(Boolean).join("\n");
